!function (e, t) {
    ...
    var qt = n(e), Jt = n(t), Yt = n(r), o = function (e) {
        ...
        ce(h = "decoder-pro.wasm") || (h = function (e) {
            ...
            ops_table: null, mount: function (e) {
                ...
                T.ops_table || (T.ops_table = {
                    dir: {
                        ...
                        node: {getattr: T.node_ops.getattr, setattr: T.node_ops.setattr}, stream: {
                        ...
                        node: {
                            getattr: T.node_ops.getattr, setattr: T.node_ops.setattr, readlink: T.node_ops.readlink
                        }, stream: {}
                    }, chrdev: {
                        node: {getattr: T.node_ops.getattr, setattr: T.node_ops.setattr}, stream: k.chrdev_stream_ops
                    }
                });
        ...
        function ze(e) {
            ...
            function n() {
                return this.isSmartPointer ? We(this.registeredClass.instancePrototype, {
                    ptrType: this.pointeeType, ptr: t, smartPtrType: this, smartPtr: e
            ...
            return null === o ? n.call(this) : this.isSmartPointer ? We(r.registeredClass.instancePrototype, {
                ptrType: r, ptr: o, smartPtrType: this, smartPtr: e
        ...
        var jt = {
            s: function (e) {
            ...
            }, l: function (u, e, t, l, r, c, n, d, o, f, p, i, h) {
                ...
                R(e, {
                    name: r = D(r), fromWireType: o, argPackAdvance: 8, readValueFromPointer: o
                ...
                o = D(o), 2 === u ? (l = kt, i = At, a = Dt, c = () => K, d = 1) : 4 === u && (l = Ct, i = Pt, a = St, c = () => p, d = 2), R(e, {
                    name: o, fromWireType: function (e) {
        ...
        }, y._ff_h264_cabac_tables = 112796, o = function e() {
            Vt || Gt(), Vt || (o = e)
...
function d(s) {
    ...
    let n = [], u = [], o = {}, i = new AbortController, a = null, l = null, e = null, c = null, d = null, f = null,
        p = !1, h = !1, m = !1, y = null, g = null, v = [], w = 0, E = 0, b = ("VideoEncoder" in self && (o = {
            hasInit: !1, isEmitInfo: !1, offscreenCanvas: null, offscreenCanvasCtx: null, decoder: new VideoDecoder({
                output: function (t) {
                    var e;
                    o.isEmitInfo || (b.opt.debug && console.log("Jessibuca: [worker] Webcodecs Video Decoder initSize"), postMessage({
                        cmd: C, w: t.codedWidth, h: t.codedHeight
                        ...
                        cmd: P, buffer: e, delay: b.delay, ts: 0
            ...
            opt: {
                ...
                b.getDelay(t.ts) > b.opt.videoBuffer + b.opt.videoBufferDelay * b.opt.playbackRate && this.dropBuffer(), 1 === t.type ? n.push({
                    ts: t.ts, payload: e, decoder: {decode: b.decodeAudio}, type: 1, isIFrame: !1
                }) : 2 === t.type && n.push({
                    ts: t.ts, payload: e, decoder: {decode: b.decodeVideo}, type: 2, isIFrame: t.isIFrame
                })
                ...
                1 === t.type ? b.opt.hasAudio && (postMessage({
                    cmd: F, type: "streamAbps", value: e.byteLength
                }), r === k ? b.pushBuffer(e, {
                    type: t.type, ts: t.ts
                }) : r === A && _.decode(e, t.ts)) : 2 === t.type && b.opt.hasVideo && (postMessage({
                    cmd: F, type: "streamVbps", value: e.byteLength
                }), r === k ? b.pushBuffer(e, {
                    type: t.type, ts: t.ts, isIFrame: t.isIFrame
                ...
                b.useOffscreen() ? (this.webglObj.renderYUV(d, f, r), e = this.offscreenCanvas.transferToImageBitmap(), postMessage({
                    cmd: P, buffer: e, delay: this.delay, ts: t
